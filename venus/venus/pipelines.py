...
from venus.settings import MYSQL_HOST, MYSQL_DB_NAME, MYSQL_USER, MYSQL_PORT, MYSQL_PASSWD, \
    MYSQL_CHARSET
...
class ToRRezPipeline:
    def __init__(self, dbpool):
        self.dbpool = dbpool
        self.ITME_TYPE_MAP = {
            ('venus', GoodsItem): self.do_insert_forums_goods,
            ('venus', PageItem): self.do_insert_forums_original_page,
            ('venus', SiteItem): self.do_insert_site_info
        }
